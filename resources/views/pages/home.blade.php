    ...
    <div class="container mx-auto">
        ...
        <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {{-- Card 1 - Teknik komputer dan jaringan --}}
                <div data-aos="fade-up">
                    <a href="#"
                        ...
                        <div class="p-8 flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Teknik komputer dan jaringan </h3>
                ...
                <div data-aos="fade-up">
                    <a href="#"
                        ...
                        <img class="w-full h-64 object-cover rounded-t-lg" src="{{ asset('assets/img/prospek2.png') }}"
                            alt="Bisnis">
                        <div class="p-8 flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Teknik sepeda motor</h3>
                ...
                <div data-aos="fade-up">
                    <a href="#"
                        ...
                        <img class="w-full h-64 object-cover rounded-t-lg" src="{{ asset('assets/img/prospek3.png') }}"
                            alt="Perkantoran">
                        <div class="p-8 flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Teknik kendaraan ringan</h3>
